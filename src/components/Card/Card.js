...
import { addProduct } from '../../services/cartSlice/cartSlice';
import './Card.css'
...
const Card = ({data}) => {
    ...
    return (
        <div className=' border-2 rounded-[6px] max-w-[250px] h-[400px] relative'>
            ...
            <button onClick={()=>dispatch(addProduct(data))} className='bg-[#333333] w-[100%] text-white font-semibold rounded-b-[6px] p-2 absolute bottom-0'>Add to Cart</button>
